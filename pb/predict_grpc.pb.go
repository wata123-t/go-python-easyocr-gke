...
type PredictorClient interface {
	// Predict関数：画像データを送ると、結果のテキストが返ってくる
	Predict(ctx context.Context, in *ImageRequest, opts ...grpc.CallOption) (*PredictResponse, error)
}
...
func (c *predictorClient) Predict(ctx context.Context, in *ImageRequest, opts ...grpc.CallOption) (*PredictResponse, error) {
...
type PredictorServer interface {
	// Predict関数：画像データを送ると、結果のテキストが返ってくる
	Predict(context.Context, *ImageRequest) (*PredictResponse, error)
...
func (UnimplementedPredictorServer) Predict(context.Context, *ImageRequest) (*PredictResponse, error) {
...
func RegisterPredictorServer(s grpc.ServiceRegistrar, srv PredictorServer) {
	// If the following call panics, it indicates UnimplementedPredictorServer was
...
func _Predictor_Predict_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PredictorServer).Predict(ctx, req.(*ImageRequest))
	}
